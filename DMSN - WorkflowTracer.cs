...
{
    public static class WorkflowTracer
    {
        /// <summary>
        /// Dumps everything interesting from the workflow context to the plugin trace log
        /// </summary>
        /// <param name="tracingservice"></param>
        /// <param name="context">The workflow context to trace.</param>
        ...
        public static void TraceContext(this ITracingService tracingservice, IWorkflowContext context, bool parentcontext, bool attributetypes, bool convertqueries, bool expandcollections, IOrganizationService service)
        {
            try
            {
        ...
        private static void TraceContext(this ITracingService tracingservice, IWorkflowContext context, bool parentcontext, bool attributetypes, bool convertqueries, bool expandcollections, IOrganizationService service, int depth)
        {
            tracingservice.Trace("--- Context {0} Trace Start ---", depth);
            tracingservice.Trace("Message : {0}", context.MessageName);
            tracingservice.Trace("Stage   : Workflow");
            ...
            {
                tracingservice.TraceContext(context.ParentContext, parentcontext, attributetypes, convertqueries, expandcollections, service, depth + 1);
            }
        }
